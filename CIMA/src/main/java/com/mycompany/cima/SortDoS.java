 ...
 * @author HP
 */
public class SortDoS extends javax.swing.JFrame {
     ...
     */
    public SortDoS(java.awt.Frame parent, boolean modal) {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblName.setText("Sắp Xếp Theo Ngày Đăng Kí !");
    ...
    private void SortDoSDown(ArrayList<Customers> list) {
    SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
    Collections.sort(list, new Comparator<Customers>() {
        @Override
        public int compare(Customers c1, Customers c2) {
            try {
                return dateFormat.parse(c2.getDoS()).compareTo(dateFormat.parse(c1.getDoS())); // Chú ý sự khác biệt ở đây
    ...
    private void SortDoSUp(ArrayList<Customers> list) {
        SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
        Collections.sort(list, new Comparator<Customers>() {
            @Override
            public int compare(Customers c1, Customers c2) {
                try {
                    return dateFormat.parse(c1.getDoS()).compareTo(dateFormat.parse(c2.getDoS())); // Không có sự thay đổi ở đây
                } catch (ParseException e) {
                    e.printStackTrace();
                    return 0;
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SortDoS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SortDoS sb = new SortDoS(new javax.swing.JFrame(), true);
    ...
    public void setSortDoS(ArrayList<Customers> list) {
        SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
        Collections.sort(list, new Comparator<Customers>() {
            @Override
            public int compare(Customers c1, Customers c2) {
                try {
                    return dateFormat.parse(c1.getDoS()).compareTo(dateFormat.parse(c2.getDoS()));
                } catch (ParseException e) {
                    e.printStackTrace();
                    return 0;
                }
