...
public class CustomerManagement extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        if (ListCustomer.getColumnModel().getColumnCount() > 0) {
            ...
            ListCustomer.getColumnModel().getColumn(1).setMinWidth(90);
            ListCustomer.getColumnModel().getColumn(1).setPreferredWidth(100);
            ...
            ListCustomer.getColumnModel().getColumn(3).setMinWidth(80);
            ListCustomer.getColumnModel().getColumn(3).setPreferredWidth(100);
            ListCustomer.getColumnModel().getColumn(3).setMaxWidth(110);
            ListCustomer.getColumnModel().getColumn(4).setMinWidth(80);
            ListCustomer.getColumnModel().getColumn(4).setPreferredWidth(100);
            ListCustomer.getColumnModel().getColumn(4).setMaxWidth(110);
        }
